        ...
        <Card className="shadow-card">
          <CardContent className="pt-6 pb-6">
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              {/* Simple HTML Button for Google Login */}
              <button 
                onClick={handleGoogleSignIn}
                className="w-full h-12 text-base font-medium gap-3 border rounded-md bg-background hover:bg-accent hover:text-accent-foreground transition-colors flex items-center justify-center"
                disabled={googleLoading}
              >
                {googleLoading ? (
                  <Loader2 className="h-4 w-4 animate-spin" />
